...
加えて、会社運用で共通参照できる情報セキュリティとAI利用の基本ガイドラインを管理します。
...
- `security/SECURITY_MANUAL.md`: 全社向けの情報セキュリティ基本マニュアル

### AI利用

生成AIを業務で安全かつ効果的に利用するための全社共通ルールです。
...
- `ai/incident-cases/`: AI利用に伴う過去のインシデント事例
